...
<div class="zt_pos"><span class="left">当前位置：<a href="/" title="">首页</a> > <a href="<?php echo $info[url]?>" title=""><?php echo $info[title]?></a></span><span class="right"><font color="red">温馨提示：请按“Ctrl+D”收藏本页</font></span></div>	

<div class="clear mt10"></div>
<?php include template('special', 'left'); ?>
<div class="zt_R_main">
<h3 class="zt_h3_1"><strong class="left"><a href="/index.php?m=special&c=index&a=category&specialid=<?php echo $specialid?>&typeid=57" title=""><?php echo $info[title]?>杂志往期目录</a></strong><span class="right"><a href="/index.php?m=special&c=index&a=category&specialid=<?php echo $specialid?>&typeid=57" title="">更多>></a></span></h3>
