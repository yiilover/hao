...
<div class="zt_R_main">
<h3 class="zt_h3_1"><strong><a href="zazhi/list.php?navid=293" title="投稿论文">《<?php echo $info[title]?>》投稿论文</a></a></strong></h3>
...
<li>
<span class="left"><?php if($r['status']==1) { ?><font color="red">[已审核]</font><?php } else { ?><font color="blue">[待审核]</font><?php } ?>&nbsp;<a href="<?php echo $r['url'];?>" target="_blank" title="<?php echo $r['title'];?>"><?php echo str_cut($r['title'], 100);?></a></span><span class="right">作者：<?php echo $r['author'];?></span>
</li>
<?php $n++;}unset($n); ?>
