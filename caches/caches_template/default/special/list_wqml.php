...
<div class="zt_R_main">
<h3 class="zt_h3_1"><strong><a title="往期目录" href="/index.php?m=special&c=index&a=category&specialid=<?php echo $specialid?>&typeid=57">《<?php echo $info[title]?>》往期目录</a></strong></h3>
...
<li>
<span class="left"><a title="<?php echo $r['title'];?>" target="_blank" href="<?php echo $r['url'];?>"><?php echo $r['title'];?></a></span><span class="right"></span>
</li>
<?php $n++;}unset($n); ?>
